...
public class ECHooks {
    ...
    public static int ceilMaxLevel(Enchantment enchantment, int level) {
        ...
        int levelCap = MathHelper.clamp_int(wrapper.getMaxLevel(), wrapper.getMinLevel(), EnumConfigSettings.ANVIL_LEVEL_CAP.getIntValue());
        ...
        for (Enchantment enchantment : Enchantment.REGISTRY) {
            ...
            if (wrapper.isEnabled()) {
                if ((!wrapper.isTreasure() || allowTreasure) && (enchantment.canApplyAtEnchantingTable(itemStack) || (flag && wrapper.isAllowedOnBooks()))) {
                    levelCap = MathHelper.clamp_int(wrapper.getMaxLevel(), wrapper.getMinLevel(), EnumConfigSettings.ENCHANTMENT_TABLE_LEVEL_CAP.getIntValue());
    ...
    public static void addMerchantRecipe(MerchantRecipeList recipeList, Random random) {
        ...
        EnchantmentWrapper wrapper = EnchantmentWrapper.get(enchantment);
        int 
        levelCap = MathHelper.clamp_int(wrapper.getMaxLevel(), wrapper.getMinLevel(), EnumConfigSettings.MERCHANT_DEALS_LEVEL_CAP.getIntValue()),
        i = MathHelper.getRandomIntegerInRange(random, wrapper.getMinLevel(), levelCap);
    ...
    public static ItemStack apply(ItemStack itemStack, Random rand, List<Enchantment> enchantments, Logger logger) {
        ...
        wrapper = EnchantmentWrapper.get(enchantment);
        int 
        levelCap = MathHelper.clamp_int(wrapper.getMaxLevel(), wrapper.getMinLevel(), EnumConfigSettings.DUNGEON_LOOT_LEVEL_CAP.getIntValue()),
        i = MathHelper.getRandomIntegerInRange(rand, wrapper.getMinLevel(), levelCap);
    ...
    public static void getAll(Enchantment enchantment, List<ItemStack> items) {
        EnchantmentWrapper wrapper = EnchantmentWrapper.get(enchantment);
        int levelCap = MathHelper.clamp_int(wrapper.getMaxLevel(), wrapper.getMinLevel(), EnumConfigSettings.CREATIVE_TAB_LEVEL_CAP.getIntValue());
